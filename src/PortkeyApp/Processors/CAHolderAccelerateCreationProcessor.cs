...
public class CAHolderAccelerateCreationProcessor: CAHolderTransactionProcessorBase<PreCrossChainSyncHolderInfoCreated>
{
    ...
    public override async Task ProcessAsync(PreCrossChainSyncHolderInfoCreated logEvent, LogEventContext context)
    {
        ...
        caHolderIndex = new CAHolderIndex
        {
            ...
            OriginChainId = ChainHelper.ConvertChainIdToBase58(logEvent.CreateChainId)
        };
